...
import com.lucasmoraist.news_letter_ai.application.gateway.NotificationService;
...
public record SendNotification(CustomerPersistence customerPersistence, NotificationService notificationService) {
